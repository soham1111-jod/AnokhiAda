...
//       console.log("💳 Creating Cashfree session with delivery charge:", cashfreePayload);
...
//         orderId: orderId,
//         tempOrder: baseOrderData, // ✅ Include delivery charge in temp order
...
// // ✅ Enhanced verify payment with correct payment method
...
//     if (!orderId || !tempOrder) {
//       return res.status(400).json({
//         success: false,
//         message: "Order ID and temp order data are required",
//       });
//     }
...
//         // ✅ Ensure payment method is correctly set as 'online'
//         const successfulOrder = new Order({
//           ...tempOrder,
//           paymentStatus: 'paid',
//           status: 'processing',
//           paymentMethod: 'online', // ✅ Explicitly set as online
//           paymentId: paymentId || paymentDetails[0]?.cf_payment_id,
//           cashfreeOrderId: orderId
//         });

//         const savedOrder = await successfulOrder.save();

//         // ✅ Enhanced notification with total amount
//         await createNotification(
//           tempOrder.userId,
//           "Payment Successful!",
//           `Your payment of ₹${tempOrder.totalAmount} has been processed successfully. Order #${savedOrder._id
//             .toString()
//             .slice(-6)
...
//         console.log("✅ Online payment order created:", {
...
//           paymentStatus: "paid",
//           status: "processing",
//           paymentMethod: "online", // ✅ Ensure correct payment method
//           paymentId: paymentId,
//           cashfreeOrderId: orderId,
//         });
...
//           tempOrder.userId,
//           "Payment Received",
//           `Your payment of ₹${tempOrder.totalAmount} has been received. Order #${savedOrder._id
//             .toString()
//             .slice(-6)
...
//         select: "Product_name Product_image Hamper_price Product_price name image",
...
//     if (orders.length > 0) {
//       console.log('🔍 Sample populated item:', orders[0].items[0]);
//     }
