  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.error("Footer: Failed fetching categories", e.message);
        setCategories([]);
      }
    })();
  }, []);

  // Map links to routes for SPA linking
  const quickLinks = [
            ...
            <ul className="space-y-3">
              {categories.length > 0 ? (
                categories.map((cat, idx) => (
                  ...
                  >
                    <Link
                      to={`/category/${cat.name ? cat.name.toLowerCase() : ""}`}
                      className="text-gray-700 hover:text-purple-600 transition-colors flex items-start group"
                    >
                      <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                      {cat.name}
          ...
          >
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <a
                  href="mailto:anokhiada.fashion@gmail.com"
              ...
              >
                ...
                <a href="tel:+918789745872" className="text-gray-700 hover:text-purple-600">
                  +91 87897 45872
                </a>
              </motion.div>
